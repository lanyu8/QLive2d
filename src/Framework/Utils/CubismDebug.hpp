...
#define CubismLogPrintln(level, fmt, ...) CubismLogPrint(level, fmt "\n", ##__VA_ARGS__)
    ...
    #define CubismLogVerbose(fmt, ...)                                                                                                          \
        CubismLogPrintln(Live2D::Cubism::Framework::CubismFramework::Option::LogLevel_Verbose, "[V]" fmt, ##__VA_ARGS__)
    #define CubismLogDebug(fmt, ...)                                                                                                            \
        CubismLogPrintln(Live2D::Cubism::Framework::CubismFramework::Option::LogLevel_Debug, "[D]" fmt, ##__VA_ARGS__)
    ...
    #define CubismLogWarning(fmt, ...)                                                                                                          \
        CubismLogPrintln(Live2D::Cubism::Framework::CubismFramework::Option::LogLevel_Warning, "[W]" fmt, ##__VA_ARGS__)
    #define CubismLogError(fmt, ...)                                                                                                            \
        CubismLogPrintln(Live2D::Cubism::Framework::CubismFramework::Option::LogLevel_Error, "[E]" fmt, ##__VA_ARGS__)
