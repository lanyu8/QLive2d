...
#define CSM_JSON_ERROR_INDEX_OUT_OF_BOUNDS "Error:index out of bounds"
                ...
                //                    一時的な返り値として返すエラー。CubismFramework::Dispose()するまではCSM_DELETEしない static Value
                ...
                //                    /**
                //                     * @brief   要素を文字列で返す(QString型)
                //                     *
                //                     */
                //                    virtual const QString &GetString(const QString &defaultValue = "", const QString &indent = "") = 0;

                //                    /**
                //                     * @brief   要素を文字列で返す(csmChar*)
                //                     *
                //                     */
                //                    //                    virtual const QString &GetRawString(const QString &defaultValue = "", const
                //                    QString &indent = "")
                //                    //                    {
                //                    //                        return this->GetString(defaultValue, indent).toWCharArray();
                //                    //                    }
                ...
                //                     *
                //                     */
                //                    virtual csmInt32 GetSize()
                //                    {
                //                        return 0;
                //                    }

                //                    /**
                //                     * @brief   要素をコンテナで返す(QVector<Value*>)
                //                     *
                //                     */
                //                    virtual QVector<Value *> *GetVector(QVector<Value *> *defaultValue = NULL)
                //                    {
                //                        return defaultValue;
                //                    }

                //                    /**
                //                     * @brief   要素をマップで返す(csmMap<QString, Value*>)
                //                     *
                //                     */
                //                    virtual csmMap<QString, Value *> *GetMap(csmMap<QString, Value *> *defaultValue = NULL)
                //                    {
                //                        return defaultValue;
                //                    }
                ...
                //                     *
                //                     */
                //                    virtual Value &operator[](const QString &)
                //                    {
                ...
                //                     * @return  マップのキー一覧
                //                     */
                //                    virtual QVector<QString> &GetKeys()
                //                    {
                //                        return *s_dummyKeys;
                //                    }
                ...
                //                     */
                //                    virtual csmBool Equals(const QString &)
                //                    {
                //                        return false;
                //                    }
                ...
                //                     */
                //                    virtual Value *SetErrorNotForClientCall(const QString &)
                //                    {
                //                        return ErrorValue;
                //                    }

                //                  protected:
                //                    QString _stringBuffer; ///< 文字列バッファ

                //                  private:
                //                    static QVector<QString> *s_dummyKeys; ///< ダミーキー
                ...
                //                     *
                //                     */
                //                    const QString &GetParseError() const
                //                    {
                //                        return _error;
                //                    }
                ...
                //                     *
                //                     */
                //                    csmBool CheckEndOfFile() const
                //                    {
                //                        return (*_root)[1].Equals("EOF");
                //                    }
                ...
                //                     * @return      パースした文字列要素
                //                     */
                //                    QString ParseString(const QString &string, csmInt32 length, csmInt32 begin, csmInt32 *outEndPos);
                ...
                //                     */
                //                    Value *ParseObject(const QString &buffer, csmInt32 length, csmInt32 begin, csmInt32 *outEndPos);
                ...
                //                     * @return      パースから取得したValueオブジェクト
                //                     */
                //                    Value *ParseArray(const QString &buffer, csmInt32 length, csmInt32 begin, csmInt32 *outEndPos);
                ...
                //                     * @return      パースから取得したValueオブジェクト
                //                     */
                //                    Value *ParseValue(const QString &buffer, csmInt32 length, csmInt32 begin, csmInt32 *outEndPos);
                ...
                //                     *
                //                     */
                //                    virtual const QString &GetString(const QString & = "", const QString & = "")
                //                    {
                //#if defined(CSM_TARGET_WIN_GL) || defined(_MSC_VER)
                //                        csmChar strbuf[32] = { '\0' };
                //                        _snprintf_s(strbuf, 32, 32, "%f", this->_value);
                //                        _stringBuffer = QString(strbuf);
                ...
                //                    virtual const QString &GetString(const QString & = "", const QString & = "")
                //                    {
                //                        _stringBuffer = QString(_boolValue ? "true" : "false");
                //                        return _stringBuffer;
                //                    }
                ...
                //                     *@brief 引数の値と等しければtrue。
                //                     */
                //                    virtual csmBool Equals(const QString &v)
                //                    {
                //                        return (_stringBuffer == v);
                //                    }
                ...
                //                     * @brief    エラー情報をセットする
                //                     */
                //                    virtual Value *SetErrorNotForClientCall(const QString &s)
                //                    {
                //                        this->_stringBuffer = s;
                //                        return this;
                //                    }
                ...
                //                     * @brief   引数付きコンストラクタ
                //                     */
                //                    Error(const QString &s, csmBool isStatic) : String(s), _isStatic(isStatic)
                //                    {
                //                    }
                ...
                //                     *
                //                     */
                //                    virtual const QString &GetString(const QString & = "", const QString &indent = "")
                //                    {
                //                        _stringBuffer = indent + "[\n";
                //                        QVector<Value *>::iterator ite = _array.Begin();
                ...
                //                     *
                //                     */
                //                    virtual QVector<Value *> *GetVector(QVector<Value *> * = NULL)
                //                    {
                //                        return &_array;
                //                    }
                ...
                //                    virtual csmInt32 GetSize()
                //                    {
                //                        return static_cast<csmInt32>(_array.GetSize());
                //                    }

                //                  private:
                //                    QVector<Value *> _array; ///< JSON要素の値
                //                };
                ...
                //                     * @brief    添字演算子[QString]
                //                     */
                //                    virtual Value &operator[](const QString &s)
                //                    {
                //                        Value *ret = _map[s];
                //                        if (ret == NULL)
                //                        {
                ...
                //                    //                    virtual Value &operator[](const QString &s)
                //                    //                    {
                //                    //                        for (csmMap<QString, Value *>::const_iterator iter = _map.Begin(); iter !=
                //                    _map.End(); ++iter)
                //                    //                        {
                //                    //                            if (iter->First == s)
                //                    //                            {
                ...
                //                    {
                //                        _stringBuffer = indent + "{\n";
                //                        csmMap<QString, Value *>::const_iterator ite = _map.Begin();
                //                        while (ite != _map.End())
                //                        {
                //                            const QString &key = (*ite).First;
                //                            Value *v = (*ite).Second;
                ...
                //                     * @brief    要素をMap型で返す
                //                     */
                //                    virtual csmMap<QString, Value *> *GetMap(csmMap<QString, Value *> * = NULL)
                //                    {
                //                        return &_map;
                //                    }
                ...
                //                    virtual csmInt32 GetSize()
                //                    {
                //                        return static_cast<csmInt32>(_keys->GetSize());
                //                    }

                //                  private:
                //                    csmMap<QString, Value *> _map; ///< JSON要素の値
                //                    QVector<QString> *_keys;     ///< JSON要素の値
                //                };
            } // namespace Utils
        }     // namespace Framework
    }         // namespace Cubism
