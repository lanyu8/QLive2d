...
#define CSM_JSON_ERROR_INDEX_OUT_OF_BOUNDS "Error:index out of bounds"
                ...
                class CubismJson
                {
                  public:
                     ...
                     *
                     */
                    const csmChar *GetParseError() const
                    {
                        return _error;
                    }
                ...
                class String : public Value
                {
                  public:
                     ...
                     * @brief   引数付きコンストラクタ
                     */
                    String(const csmString &s) : Value()
                    {
                ...
                class Error : public String
                {
                  ...
                  protected:
                     ...
                     * @brief   引数付きコンストラクタ
                     */
                    Error(const csmString &s, csmBool isStatic) : String(s), _isStatic(isStatic)
                    {
                    }
