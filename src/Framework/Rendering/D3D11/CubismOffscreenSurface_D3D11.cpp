        ...
        namespace Framework
        {
            namespace Rendering
            {
                ...
                CubismOffscreenFrame_D3D11::CubismOffscreenFrame_D3D11()
                    : _texture(NULL), _textureView(NULL), _renderTargetView(NULL), _depthTexture(NULL), _depthView(NULL), _backupRender(NULL),
                      _backupDepth(NULL), _bufferWidth(0), _bufferHeight(0)
                {
                }
                ...
                void CubismOffscreenFrame_D3D11::BeginDraw(ID3D11DeviceContext *renderContext)
                {
                    ...
                    // OMSetRenderTargets: Resource being set to OM RenderTarget slot 0 is still bound on input! [ STATE_SETTING WARNING #9:
                ...
                csmBool CubismOffscreenFrame_D3D11::CreateOffscreenFrame(ID3D11Device *device, csmUint32 displayBufferWidth,
