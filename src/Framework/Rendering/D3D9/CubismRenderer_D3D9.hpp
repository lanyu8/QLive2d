            ...
            namespace Rendering
            {
                ...
                class CubismRenderer_D3D9 : public CubismRenderer
                {
                  ...
                  public:
                     ...
                     *
                     */
                    void ExecuteDraw(LPDIRECT3DDEVICE9 device, CubismVertexD3D9 *vertexArray, csmUint16 *indexArray, const csmInt32 vertexCount,
                                     const csmInt32 triangleCount, const csmInt32 textureNo, CubismTextureColor &modelColorRGBA,
                  ...
                  protected:
                     ...
                     *
                     */
                    void DrawMeshDX9(csmInt32 drawableIndex, csmInt32 textureNo, csmInt32 indexCount, csmInt32 vertexCount,
                  ...
                  private:
                    ...
                    csmMap<csmInt32, LPDIRECT3DTEXTURE9>
