            ...
            namespace Rendering
            {
                ...
                class CubismRenderState_D3D9
                {
                  ...
                  public:
                     ...
                     */
                    void SetBlend(LPDIRECT3DDEVICE9 device, bool enable, bool alphaSeparateEnable, D3DBLEND srcmul, D3DBLENDOP blendFunc,
                                  D3DBLEND destmul, D3DBLEND srcalpha, D3DBLENDOP alphaFunc, D3DBLEND destalpha, csmBool force = false);
                     ...
                     * @param   force[in]       trueの場合は今の設定が何であろうと強制設定
                     */
                    void SetViewport(LPDIRECT3DDEVICE9 device, DWORD left, DWORD top, DWORD width, DWORD height, float zMin, float zMax,
                                     csmBool force = false);
                     ...
                     */
                    void SetTextureFilter(LPDIRECT3DDEVICE9 device, D3DTEXTUREFILTERTYPE minFilter, D3DTEXTUREFILTERTYPE magFilter,
                                          D3DTEXTUREFILTERTYPE mipFilter, D3DTEXTUREADDRESS addressU, D3DTEXTUREADDRESS addressV,
                                          csmBool force = false);
